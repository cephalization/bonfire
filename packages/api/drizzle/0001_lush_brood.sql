...
ALTER TABLE `vms` ADD `organization_id` text REFERENCES organization(id);--> statement-breakpoint
ALTER TABLE `vms` ADD `created_by_id` text REFERENCES user(id);--> statement-breakpoint
CREATE INDEX `vms_organization_id_idx` ON `vms` (`organization_id`);